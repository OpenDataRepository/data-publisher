        ...
        page.open(address, function (status) {
            if (status !== 'success') {
                ...
                var CheckGraph = function () {
                    ...
                    window.clearInterval(window.graph_ready)

                    // Check if graph is done
                    var graph_done = document.getElementById("PlotlyDone")

                    if(undefined == graph_done) {
                        console.log('resetting interval')
                        window.graph_ready = window.setInterval(CheckGraph, 100)
                    }
                    else {
