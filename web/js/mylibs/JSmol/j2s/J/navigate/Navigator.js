...
break;
case 1:
if (!this.runSleep(Clazz.floatToInt(this.secondsTotal * 1000) - 30, -2)) return;
mode = -2;
break;
case -2:
if (this.isNavTo) {
...
function(){
this.isNavTo = true;
if (!this.vwr.haveDisplay) this.secondsTotal = 0;
var fps = 30;
this.totalSteps = Clazz.floatToInt(this.secondsTotal * fps) - 1;
