...
this.asc.setCurrentModelInfo("f2cTitle", this.symmetry.getSpaceGroupTitle());
...
Clazz_load(["J.api.SymmetryInterface"], "JS.Symmetry", ["java.util.Hashtable", "JU.BS", "$.JSJSONParser", "$.Lst", "$.M4", "$.P3", "$.PT", "$.Rdr", "J.api.Interface", "J.bspt.Bspt", "JS.PointGroup", "$.SpaceGroup", "$.SymmetryInfo", "$.SymmetryOperation", "$.UnitCell", "JU.Escape", "$.Logger", "$.SimpleUnitCell", "JV.FileManager"], function(){
var c$ = Clazz_decorateAsClass(function(){
...
Clazz_overrideMethod(c$, "getSpaceGroupTitle", 
function(){
...
return (Clazz_instanceOf(def,Array) ? def : JS.UnitCell.getMatrixAndUnitCell(this.unitCell, def, retMatrix));
}, "~O,JU.M4");
...
this.intlTableNumberExt = sg.intlTableNumberExt;
this.intlTableNumberFull = sg.intlTableNumberFull;
...
this.setIntlTableNumberFull(this.intlTableNumberFull);
if (!terms[1].equals("0")) {
...
function(){
return (this.intlTableNumberFull == null ? this.name : this.intlTableNumberFull + " HM:" + this.hmSymbolFull + " Hall:" + this.hallSymbol);
});
...
;//5.0.1-v2 Thu Mar 14 15:04:45 CDT 2024
Clazz_declarePackage("JS");
...
Clazz_defineMethod(c$, "setIsActiveCell", 
function(TF){
...
if (retMatrix == null ? uc == null : !((typeof(def)=='string'))) return null;
var m;
var isRev = false;
var pts =  new Array(4);
...
m.setTranslation(JU.P3.new3(ftrans[0], ftrans[1], ftrans[2]));
if (sdef.indexOf("a") >= 0) m.transpose33();
}if (retMatrix != null) {
retMatrix.setM4(m);
