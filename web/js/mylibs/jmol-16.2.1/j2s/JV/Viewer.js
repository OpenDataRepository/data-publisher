...
switch (tok) {
case 603979838:
this.g.elementKeys = value;
this.getModelkit(false).setProperty("setelementkeys", Boolean.$valueOf(value));
break;
case 603979956:
...
function(bs, type, paramsOrUC){
return this.getModelkit(false).cmdAssignSpaceGroup(bs, type, paramsOrUC);
}, "JU.BS,~S,~O");
...
;//5.0.1-v2 Fri Mar 15 15:24:57 CDT 2024
