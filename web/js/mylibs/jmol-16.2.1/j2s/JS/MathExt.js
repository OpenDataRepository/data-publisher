...
if (args.length == 0) return mp.addXObj(this.vwr.getSymTemp().getSpaceGroupInfo(this.vwr.ms, null, this.vwr.am.cmi, true, null));
...
if (args[0].tok != 2) return false;
return mp.addXObj(this.vwr.getSymTemp().getSpaceGroupJSON(this.vwr, "settings", null, args[0].intValue));
}if (args[0].tok == 4) {
...
if (asMatrix) {
var m =  new JU.M4();
this.vwr.getSymTemp().getV0abc(arg0, m);
ret = m;
} else {
...
;//5.0.1-v2 Fri Mar 15 16:20:06 CDT 2024
