...
#sudo setfacl -R -m u:"$HTTPDUSER":rwX -m u:`whoami`:rwX app app/cache app/logs app/crypto_dir app/tmp web/uploads
sudo setfacl -dR -m u:"$HTTPDUSER":rwX -m u:`whoami`:rwX app app/cache app/logs app/tmp
#sudo setfacl -dR -m u:"$HTTPDUSER":rwX -m u:`whoami`:rwX app app/cache app/logs app/crypto_dir app/tmp web/uploads
