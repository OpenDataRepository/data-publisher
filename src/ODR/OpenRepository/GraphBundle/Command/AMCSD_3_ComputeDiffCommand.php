...
class AMCSD_3_ComputeDiffCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln('[odr_amcsd_update:3_diff] started '.(new \DateTime())->format('Y-m-d H:i:s').' — waiting for jobs (Ctrl+C to stop)');
        while (true) {
            ...
            try {
                ...
                if ( $e->getMessage() == 'retry' ) {
                    ...
                    $logger->error('AMCSD_3_ComputeDiffCommand.php: '.$e->getMessage());
