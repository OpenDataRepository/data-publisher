...
class CheminAnalogPlugin implements DatatypePluginInterface
{
     ...
     */
    public function __construct(private readonly EntityManager $em, private readonly EntityCreationService $ec_service, private readonly LockService $lock_service, private readonly EventDispatcherInterface $event_dispatcher, private readonly \Twig\Environment $templating, private readonly LoggerInterface $logger)
    {
    }
