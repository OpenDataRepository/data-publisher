 ...
 *
 * The organization plugin requires the datatype to have a number of datafields for storing
 * metadata about a site or location where a sample was collected.
 *
 */
...
class SitePlugin implements DatatypePluginInterface
{
