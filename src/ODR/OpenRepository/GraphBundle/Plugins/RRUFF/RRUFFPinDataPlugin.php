...
//            $options = $render_plugin_instance['renderPluginOptionsMap'];
            ...
            if ( $rendering_options['context'] === 'display' ) {
                ...
                $output = $this->templating->render(
                    '@ODROpenRepositoryGraph/RRUFF/RRUFFPinData/pindata_edit_fieldarea.html.twig',
                    array(
                        'datatype_array' => array($initial_datatype_id => $datatype),
    ...
    private function getFullVectorStrs($datatype, $datarecord)
    {
        ...
        $query = $this->em->createQuery(
           'SELECT df.id AS df_id, ro.optionName
            ...
            LEFT JOIN ODR\AdminBundle\Entity\DataFields df WITH drf.dataField = df
        ...
        if ( $rendering_context === 'edit' ) {
            ...
            if ( isset($vector_df_ids[$datafield->getId()]) ) {
                ...
                return array(
                    ...
                    'template_name' => '@ODROpenRepositoryGraph/RRUFF/RRUFFPinData/pindata_edit_vector_datafield.html.twig',
                ...
                return array(
                    'token_list' => array(),    // so ODRRenderService generates CSRF tokens
                    'template_name' => '@ODROpenRepositoryGraph/RRUFF/RRUFFPinData/pindata_display_orientation_datafield.html.twig',
                );
            }
        }
