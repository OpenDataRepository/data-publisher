...
class IMAPlugin implements DatatypePluginInterface, DatafieldDerivationInterface, DatafieldReloadOverrideInterface, MassEditTriggerEventInterface, SearchOverrideInterface, TableResultsOverrideInterface
{
     ...
     */
    public function __construct(private readonly EntityManager $em, private readonly DatabaseInfoService $database_info_service, private readonly DatarecordInfoService $datarecord_info_service, private readonly EntityCreationService $entity_create_service, private readonly EntityMetaModifyService $entity_modify_service, private readonly LockService $lock_service, private readonly SearchService $search_service, private readonly EventDispatcherInterface $event_dispatcher, private readonly \Twig\Environment $templating, private readonly LoggerInterface $logger)
    {
    }
    ...
    public function execute($datarecords, $datatype, $render_plugin_instance, $theme_array, $rendering_options, $parent_datarecord = [], $datatype_permissions = [], $datafield_permissions = [], $token_list = [])
    {
        try {
            ...
            if ( $rendering_options['context'] === 'display' ) {
                ...
                $special_tokens[$mineralid_field_id] = $token_id;
