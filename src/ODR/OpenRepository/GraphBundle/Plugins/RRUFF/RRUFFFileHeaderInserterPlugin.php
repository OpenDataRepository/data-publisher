...
class RRUFFFileHeaderInserterPlugin implements DatafieldHeaderPluginInterface, PluginSettingsDialogOverrideInterface, MassEditTriggerEventInterface
{
...
//                );
    ...
    private function isEventRelevant($datafield)
    {
        ...
        foreach ($df['renderPluginInstances'] as $rpi_id => $rpi) {
            ...
            // The RenderPlugin system doesn't stop this plugin and the FileHeaderInserterPlugin from
            //  being active at the same time...because I'm not currently inclined to overhaul the
            //  plugin system, I'm going to throw an exception here
