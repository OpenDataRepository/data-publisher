 ...
 * RRUFF Chemistry Analysis Plugin
...
class RRUFFChemistryAnalysisPlugin implements DatatypePluginInterface
{
    ...
    /**
     * Executes the RRUFF Chemistry Analysis Plugin on the provided datarecord
     *
