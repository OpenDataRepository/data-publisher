...
* import_datatype tube and passes the parameters to XMLController,
* which uses the data to create more beanstalk jobs to validate
* each of the XML files in a particular directory on the server as
* part of an XML import.
*
*/
...
//$logger->debug('XMLImportStartCommand.php: curl results...'.print_r($result, true));
                ...
                if ( $e->getMessage() == 'retry' ) {
                    ...
                    $logger->error('XMLImportStartCommand.php: '.$e->getMessage());
