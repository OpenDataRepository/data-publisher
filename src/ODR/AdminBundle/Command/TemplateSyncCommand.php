 ...
 *
 * This Symfony console command takes beanstalk jobs from the synch_template tube and passes the
 * parameters to WorkerController, which will being the process of synchronizing a datatype with
 * its master template.
 */
...
class TemplateSyncCommand extends ContainerAwareCommand
{
    ...
    protected function configure()
    {
        ...
        $this
            ->setName('odr_datatype:sync_template')
            ->setDescription('Synchronizes a datatype with its master template');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        while (true) {
            ...
            try {
                ...
                $output->writeln('Sync request for Datatype '.$data->datatype_id.' from '.$data->redis_prefix.'...');
...
//$logger->debug('TemplateSyncCommand.php: curl results...'.print_r($result, true));
