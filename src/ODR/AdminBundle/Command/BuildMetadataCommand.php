...
class BuildMetadataCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln('[odr_metadata:build] started '.(new \DateTime())->format('Y-m-d H:i:s').' — waiting for jobs (Ctrl+C to stop)');
        while (true) {
...
//$logger->debug('BuildMetadataCommand.php: curl results...'.print_r($result, true));
