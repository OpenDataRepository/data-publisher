...
//            $params = array('dt_id' => 734, 'dt_734_c_by' => '276');  // should also be 43 total
...
//            https://theta.odr.io/app_dev.php/admin/asdf/eyJkdF9pZCI6IjczNiIsIjcwNjIiOiItMTA5NCwtMTEwNCIsIjc2MTQiOiJhbnRpcXVpdHkiLCI3NjEzIjoiPjAifQ
            // ...instead, it totals 2.  Hematite ~directly~ matches, while Melanterite also has a status note >0
...
//            $params = array('dt_id' => 736, '7062' => "*1094,*1104", '7035' => '""');  // should total 43 (6530-6487).  existing search system won't work
//            https://theta.odr.io/app_dev.php/ima#/app_dev.php/search/display/0/eyJkdF9pZCI6IjczNiIsIjcwMzUiOiIhXCJcIiIsIjcwNjIiOiIqMTA5NCwqMTEwNCJ9
//            https://theta.odr.io/app_dev.php/admin/asdf/eyJkdF9pZCI6IjczNiIsIjcwMzUiOiIhXCJcIiIsIjcwNjIiOiIqMTA5NCwqMTEwNCJ9
...
//            $params = array('dt_id' => 734, 'inverse' => 736, '7052' => '""');  // should total 6023 (24643-18620)  existing search system won't work
...
//            $params = array('dt_id' => 734, 7036 => 'pyroxene', 'inverse' => -1);  // should return 215 results
...
//            $params = array('dt_id' => 734, 7035 => 'downs', 7036 => 'pyroxene', 'inverse' => -1, 'merge' => 'OR');  // should return (202-10)+(215-10)+10=407 results
...
//            $params = array('dt_id' => 734, 7036 => '!pyroxene', 'inverse' => -1);  // should return (24643-215) = 24428 results
...
//            $params = array('dt_id' => 734, 7035 => '!downs', 7036 => 'pyroxene', 'inverse' => -1);  // should return (215-10)=205 results
...
//            $params = array('dt_id' => 734, 7035 => 'downs', 7036 => '!pyroxene', 'inverse' => -1, 'merge' => 'OR');  // should return (24428+10)= 24438
...
//            $params = array('dt_id' => 734, 7035 => '!downs', 7036 => '!pyroxene', 'inverse' => -1);  // should return 24643-192-205-10=24236 results
...
//            $params = array('dt_id' => 734, 7035 => '!downs', 7036 => '!pyroxene', 'inverse' => -1, 'merge' => 'OR');  // should return 24643-10=24633 results
...
//            $params = array('dt_id' => 736, 7035 => 'downs', 7036 => 'pyroxene', '7062' => "*1094,*1104");  // should return 21 results
            // NOTE: this would be 7 if the references were required to have both downs and pyroxene at the same time...but that's no longer feasible
...
//            $params = array('dt_id' => 736, 7035 => '!downs', '7062' => "*1094,*1104");  // should return (6530-368)=6162 results
...
//            $params = array('dt_id' => 736, 7035 => 'downs', 7036 => '!pyroxene', '7062' => "*1094,*1104");  // should return 347 results
//            https://theta.odr.io/app_dev.php/rruff_reference#/app_dev.php/search/display/0/eyJkdF9pZCI6NzM2LCI3MDM1IjoiIWRvd25zIiwiNzAzNiI6InB5cm94ZW5lIiwiNzA2MiI6IioxMDk0LCoxMTA0In0
//            https://theta.odr.io/app_dev.php/admin/asdf/eyJkdF9pZCI6NzM2LCI3MDM1IjoiIWRvd25zIiwiNzAzNiI6InB5cm94ZW5lIiwiNzA2MiI6IioxMDk0LCoxMTA0In0
...
//            $params = array('dt_id' => 736, 7035 => '!downs', 7036 => 'pyroxene', '7062' => "*1094,*1104", 'merge' => 'OR');  // should return 6183 results
...
//            print '<pre>'.count($array_not_downs_or_pyroxene)."\n".print_r($array_not_downs_or_pyroxene, true).'</pre>';
//            $params = array('dt_id' => 736, 7035 => 'downs', 7036 => '!pyroxene', '7062' => "*1094,*1104", 'merge' => 'OR');  // should return 6491 results
...
//            print '<pre>'.count($array_not_downs_or_pyroxene)."\n".print_r($array_not_downs_or_pyroxene, true).'</pre>';
//            $params = array('dt_id' => 736, 7035 => '!downs', 7036 => '!pyroxene', '7062' => "*1094,*1104");  // should return 6123 results
...
//            print '<pre>'.count($array_not_downs_or_pyroxene)."\n".print_r($array_not_downs_or_pyroxene, true).'</pre>';
//            $params = array('dt_id' => 736, 7035 => '!downs', 7036 => '!pyroxene', '7062' => "*1094,*1104", 'merge' => 'OR');  // should return 6509 results
