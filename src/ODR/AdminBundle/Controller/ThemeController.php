    ...
    public function navslideoutAction(Request $request)
    {
        ...
        try {
            ...
            $return['d'] = $templating->render(
                'ODRAdminBundle:Theme:nav_slideout.html.twig'
            );
        }
        catch (\Exception $e) {
            $return['r'] = 1;
        ...
        try {
            ...
            $return['d'] = array(
                'html' => $templating->render(
                    'ODRAdminBundle:Theme:radio_option_list.html.twig',
                    array(
                        'datafield' => $datafield,
...
//print '<pre>'.print_r($datatypes_with_table_themes, true).'</pre>';  exit();
            ...
            $return['d'] = array(
                'html' => $templating->render(
                    'ODRAdminBundle:Theme:link_type_dialog_form.html.twig',
                    array(
...
//throw new \Exception('do not continue');
    ...
    public function plugindialogAction($datatype_id, $datafield_id, Request $request)
    {
        ...
        try {
            ...
            $return['d'] = array(
                'html' => $templating->render(
                    'ODRAdminBundle:Theme:plugin_settings_dialog_form.html.twig',
                    array(
...
//print 'allowed fieldtypes: '.print_r($allowed_fieldtypes, true)."\n";
            ...
            if ( $return['r'] == 0 ) {
                ...
                $return['d'] = array(
                    'html' => $templating->render(
                        'ODRAdminBundle:Theme:plugin_settings_dialog_form_data.html.twig',
                        array(
                            'local_datatype' => $datatype,
                            'local_datafield' => $datafield,
...
//$datatype_form->addError( new FormError('do not save') );
                ...
                */
                ...
                $templating = $this->get('templating');
                $return['d'] = $templating->render(
                    'ODRAdminBundle:Theme:datatype_properties_form.html.twig',
                    array(
                        'datatype' => $datatype,
...
//                        case 'DecimalValue':
            ...
            if ( !$datafield_form->isSubmitted() || !$datafield_form->isValid() || $force_slideout_reload ) {
                ...
                $return['d'] = array(
                    ...
                    'html' => $templating->render(
                        'ODRAdminBundle:Theme:datafield_properties_form.html.twig',
                        array(
...
//                        "scheduled_at" => $current_time->format('Y-m-d H:i:s'),
    ...
    public function getdeleteddatafieldsAction($datatype_id, Request $request)
    {
        ...
        try {
            ...
            $return['d'] = array(
                'html' => $templating->render(
                    'ODRAdminBundle:Theme:undelete_fields_dialog_form.html.twig',
                    array(
