...
//                                throw new ODRException('RenderPlugin config file "'.$plugin_config['filepath'].'"...required_field "'.$field_id.'" has the "is_optional" property, which is not allowed with the "must_be_unique" property');
                            ...
                            switch ($field_data['type']) {
                                ...
                                default:
                                    throw new ODRException('RenderPlugin config file "'.$plugin_config['filepath'].'"...required_field "'.$field_id.'" has the "no_user_edits" property, which is not allowed on the "'.$typeclass.'" typeclass');
                            }
                        }
                    }
                }
