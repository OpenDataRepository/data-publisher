...
class DatabaseInfoService
{
    ...
    private function buildDatatypeData($grandparent_datatype_id)
    {
        ...
        foreach ($datatype_data as $dt_num => $dt) {
            ...
            $datatype_data[$dt_num]['immediateSearchField'] = [];
    ...
    public function getNameSortDatafields($datatype, $user_permissions = null)
    {
        ...
        // All of the data can be found in the cached datatype array. Ported from develop 14f3976e:
        //  index by the datatype's OWN id (not the grandparent's) so child datatypes resolve their
        //  own name/sort fields.
        ...
        $datatypes_to_check = [$datatype_id];
