...
class CacheService
{
     ...
     */
    public function __construct(private readonly Predis\Client $cache_service, private $cache_prefix, private $related_cache_prefixes)
    {
    }
    ...
    public function get($key)
    {
        ...
        if (strlen((string) $cache_value) > 0)
