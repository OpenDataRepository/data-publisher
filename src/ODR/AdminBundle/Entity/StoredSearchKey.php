 ...
 * StoredSearchKey Entity
 * (C) 2015 by Nathan Stone (nate.stone@opendatarepository.org)
 * (C) 2015 by Alex Pires (ajpires@email.arizona.edu)
 * Released under the GPLv2
 *
 * The StoredSearchKey Entity is automatically generated from
 * ./Resources/config/doctrine/StoredSearchKey.orm.yml
 *
 */
...
class StoredSearchKey
{
     ...
     * Set storageLabel.
     *
     * @param string|null $storageLabel
     *
     * @return StoredSearchKey
     */
    public function setStorageLabel($storageLabel = null)
    {
