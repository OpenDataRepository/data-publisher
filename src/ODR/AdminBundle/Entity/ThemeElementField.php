 ...
 * ThemeElementField Entity
 * (C) 2015 by Nathan Stone (nate.stone@opendatarepository.org)
 * (C) 2015 by Alex Pires (ajpires@email.arizona.edu)
 * Released under the GPLv2
 *
 * The ThemeElementField Entity is automatically generated from
 * ./Resources/config/doctrine/ThemeElementField.orm.yml
 */
...
class ThemeElementField
{
     ...
     * @return ThemeElementField
     */
    public function setThemeElement(\ODR\AdminBundle\Entity\ThemeElement $themeElement)
    {
