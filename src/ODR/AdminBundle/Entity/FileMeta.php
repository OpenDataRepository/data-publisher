 ...
 *
 * The FileMeta Entity is responsible for storing the properties
 * of the File Entity that are subject to change, and is
 * automatically generated from ./Resources/config/doctrine/FileMeta.orm.yml
 */
